        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="btn btn-secondary" href="logout.php">登出<span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </div>
    </nav>
...
?>
            ...
            <div class="post__read--main card-body">
                ...
                <!-- create comment -->
                <form class="comment__create" action="comment.php" method="POST">
